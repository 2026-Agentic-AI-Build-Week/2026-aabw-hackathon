...
describe("createSocketChatEmitter", () => {
  it("maps safe checkout updates directly to checkout_update", () => {
    ...
    const payload = { session_id: "session-1", checkout: { state: "order_created" as const, order: { orderId: "order-1", status: "CREATED" as const, total: 100000, currency: "VND", createdAt: "2026-07-12T12:00:00.000Z", paymentQrCode: "KFCQR-DEMO" } } };
